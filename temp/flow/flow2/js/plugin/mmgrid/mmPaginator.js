!function($){
    ...
    MMPaginator.prototype = {
        _initLayout: function(){
            ...
            this.$totalMoneyLabel = $el.find('.totalMoneyLabel');
        ...
        , load: function(params){
			...
			if(opts.totalMoneyName){
				var totalMoney = params[opts.totalMoneyName];
				if(totalMoney === undefined){
					totalMoney = 0;
				}
				this.$totalMoneyLabel.html(this.formatString(opts.totalMoneyLabel,[totalMoney]));
			}
    ...
    $.fn.mmPaginator.defaults = {
        ...
        , limitLabel: '每页{0}条'
        , totalMoneyLabel: '共<span>{0}</span>元'
